...
public class User {
	...
	public User(int user_id, String user_nickname, String user_password, String user_name, String user_head,
			String user_qq, String user_telephone, String user_email, String sex, String user_address, int user_state,
			String user_autograph, Date user_time) {
		super();
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_nickname=" + user_nickname + ", user_password=" + user_password
				...
				+ user_telephone + ", user_email=" + user_email + ", sex=" + sex + ", user_address=" + user_address
