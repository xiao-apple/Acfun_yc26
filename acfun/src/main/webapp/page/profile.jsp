				...
				<div class="inner">
					...
					<div id="area-user-guide">
						...
						<p class="app-text">客户端</p>
							<div class="app-show">
								<img alt="" src="css/app-code.png" class="app-code">
								<p class="app-tip">扫描下载最新版客户端</p>
								<img alt="" src="css/app-word.png" class="app-word"
									height="19" width="141">
								<div class="tail"></div>
						...
						<p>登录/注册</p></a><a id="a-avatar-guide"
							...
							class="thumb"><img src="css/avatar.jpg" class="avatar">
							...
							<div class="part-guide-left active">
								...
								<div class="mainer hidden">
									<a href="#area=setting" class="tab"><i class="icon"></i>设置</a><a
										href="page/profile.jsp" class="tab active"><i class="icon"></i>编辑资料</a>
								</div>
							</div>
							<div class="part-guide-left">
								<div class="banner">
				...
				<div class="top-footer">
					<div class="l">
						...
						<div class="erweima">
							...
							<img src="css/erweima.jpg" height="140px" width="140px">
						</div>
					</div>
					<div class="r">
