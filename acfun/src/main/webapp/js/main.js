...
(function ($) {
    ...
    var DanmuPlayer = function (element, options) {
        ...
        this.$ctrlMain.append('<div class="opacity ctrl-btn-right"><input class="ctrl-btn-right danmu-op" value="50" type="range" /></div>');
...
//                $("#danmup")[0].webkitRequestFullScreen();
//                $("#danmup").mousemove(function(){
//                	if(aaa!=undefined){
//                		window.clearTimeout(aaa);
//                	}
//                	$(".danmu-player-ctrl").fadeIn();
//                	aaa = window.setTimeout('$(".danmu-player-ctrl").fadeOut(2500)',2000);
//                });
            }
            else {
